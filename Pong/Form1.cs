...
namespace Pong
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void gameUpdateLoop_Tick(object sender, EventArgs e)
        {
            ...
            if (ballY < 0 || ballY > this.Height - ballSize) // if ball hits top line
            {
            ...
            Rectangle p1Collision = new Rectangle(p1X, p1Y, pWidth, pHeight);
            Rectangle p2Collision = new Rectangle(p2X, p2Y, pWidth, pHeight);

            Rectangle ballCollision = new Rectangle(ballX, ballY, ballSize, ballSize);
            // TODO create if statment that checks p1 collides with ball and if it does
            // --- play a "paddle hit" sound and
            // --- use ballMoveRight boolean to change direction
            if (ballCollision.IntersectsWith(p1Collision) || ballCollision.IntersectsWith(p2Collision)) 
                {
                collisionSound.Play();
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString($"P1:{player1Score} P2:{player2Score}", drawFont, drawBrush, 5, 5);
